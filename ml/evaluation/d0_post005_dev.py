"""D0-POST-005 development candidate selector.

This evaluator is intentionally development-only.

It evaluates exactly the three predeclared POST-005
candidate checkpoints against the frozen POST-005
development dataset.
...
EXPECTED_CANDIDATES = {
    40: (
        "1ea05d991a28381adc65c5af06fb1caf95ee52484"
        "d714c1ec4101275ee439796"
    ),
    80: (
        "92a8f742c9f7a37170d908f39db0dd01f26b4d9b"
        "c370218bc435df16ef029b7f"
    ),
    120: (
        "4877d292fdd8e5428db250359dc9c57ebc4f4d1c"
        "cb2a329b94bdafd2c61569d9"
    ),
}
...
def load_model(
    ...
    if actual_sha != expected_sha:
        raise ValueError(
            "POST-005 candidate identity mismatch "
...
def select_candidate(
    ...
    return {
        ...
        "reason": (
            "Selected by frozen POST-005 development "
            "policy."
        ),
    }
...
def main() -> None:
    ...
    if dataset_sha != EXPECTED_DEV_SHA256:
        raise ValueError(
            "POST-005 development dataset identity mismatch"
        )
    ...
    payload = {
        "status": "complete",
        "stage": "D0-POST-005-development",
        "policy": {
            "primaryMetric": "exactMatchCount",
            "secondaryMetric": "familyCoverage",
            "tertiaryMetric": (
                "aggregateResponseLoss"
            ),
            "minimumCondition": (
